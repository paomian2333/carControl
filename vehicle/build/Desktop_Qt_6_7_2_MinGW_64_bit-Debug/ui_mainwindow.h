...
"color: rgb(255, 0, 255);"));
        ...
        lcdNumber_secnd->setFrameShape(QFrame::Shape::Box);
        lcdNumber_secnd->setFrameShadow(QFrame::Shadow::Raised);
        ...
        pushButton_image->setEnabled(true);

        verticalLayout_3->addWidget(pushButton_image);
        ...
        pushButton_chatroom = new QPushButton(centralwidget);
        pushButton_chatroom->setObjectName("pushButton_chatroom");
        pushButton_chatroom->setFont(font2);
        QIcon icon4(QIcon::fromTheme(QIcon::ThemeIcon::AddressBookNew));
        pushButton_chatroom->setIcon(icon4);

        verticalLayout_3->addWidget(pushButton_chatroom);

        pushButton_map = new QPushButton(centralwidget);
        pushButton_map->setObjectName("pushButton_map");
        pushButton_map->setFont(font2);
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icon/mainwindow_image/map.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        pushButton_map->setIcon(icon5);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_image->setText(QCoreApplication::translate("MainWindow", "\345\233\276\347\211\207\346\265\217\350\247\210", nullptr));
        pushButton_chatroom->setText(QCoreApplication::translate("MainWindow", "\350\201\212\345\244\251\345\256\244", nullptr));
